...
pub fn convert_key(key: INT) -> Key {
    ...
    match key {
        ...
        APPCOMMAND_LAUNCH_APP2 => Key::LaunchCalculator,
        ...
        APPCOMMAND_LAUNCH_APP1 => Key::LaunchMyComputer,
