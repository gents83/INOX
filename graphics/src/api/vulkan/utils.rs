...
pub fn find_queue_family_indices(device: &VkPhysicalDevice) -> QueueFamilyIndices {
...
pub fn is_device_suitable(device:&VkPhysicalDevice) -> bool {
    ...
    let queue_family_indices = find_queue_family_indices(device);
