...
use inox_render::{
    ...
    ShaderStage, TextureId, TextureView, INSTANCE_DATA_ID,
};
...
pub const COMPUTE_AO_GENERATION_PIPELINE: &str = "pipelines/ComputeAOGeneration.compute_pipeline";
pub const COMPUTE_AO_GENERATION_NAME: &str = "ComputeAOGenerationPass";

pub struct ComputeAOGenerationPass {
...
unsafe impl Send for ComputeAOGenerationPass {}
unsafe impl Sync for ComputeAOGenerationPass {}

impl Pass for ComputeAOGenerationPass {
    fn name(&self) -> &str {
        COMPUTE_AO_GENERATION_NAME
    }
        ...
        Self: Sized,
    {
        let data = ComputePassData {
            name: COMPUTE_AO_GENERATION_NAME.to_string(),
        ...
        Self {
            ...
            meshes,
            meshlets,
            binding_data: BindingData::new(render_context, COMPUTE_AO_GENERATION_NAME),
...
impl ComputeAOGenerationPass {
    ...
    pub fn ao_rays(&self) -> &GPUVector<RayPackedData> {
        &self.ao_rays
    }
}
