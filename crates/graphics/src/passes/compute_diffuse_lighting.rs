...
pub const COMPUTE_DIFFUSE_LIGHTING_PIPELINE: &str =
    "pipelines/ComputeDiffuseLighting.compute_pipeline";
pub const COMPUTE_DIFFUSE_LIGHTING_NAME: &str = "ComputeDiffuseLightingPass";

pub struct ComputeDiffuseLightingPass {
...
unsafe impl Send for ComputeDiffuseLightingPass {}
unsafe impl Sync for ComputeDiffuseLightingPass {}

impl Pass for ComputeDiffuseLightingPass {
    fn name(&self) -> &str {
        COMPUTE_DIFFUSE_LIGHTING_NAME
    }
    ...
    fn create(context: &ContextRc, render_context: &RenderContextRc) -> Self {
        let data = ComputePassData {
            name: COMPUTE_DIFFUSE_LIGHTING_NAME.to_string(),
            pipelines: vec![PathBuf::from(COMPUTE_DIFFUSE_LIGHTING_PIPELINE)],
        };
        ...
        Self {
            ...
            binding_data: BindingData::new(render_context, COMPUTE_DIFFUSE_LIGHTING_NAME),
            dimensions: (0, 0),
        }
    }

    fn init(&mut self, render_context: &RenderContext) {
        inox_profiler::scoped_profile!("diffuse_lighting_pass::init");
    ...
    fn update(
        ...
        inox_profiler::scoped_profile!("diffuse_lighting_pass::update");
...
impl ComputeDiffuseLightingPass {
