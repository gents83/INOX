...
use inox_render::{
    ...
    ShaderStage, TextureId, TextureView, DEFAULT_HEIGHT, DEFAULT_WIDTH, INSTANCE_DATA_ID,
};
...
unsafe impl Send for ComputeGBufferPass {}
unsafe impl Sync for ComputeGBufferPass {}

impl Pass for ComputeGBufferPass {
    fn name(&self) -> &str {
        COMPUTE_GBUFFER_NAME
    }
    ...
    fn create(context: &ContextRc, render_context: &RenderContextRc) -> Self {
        let data = ComputePassData {
            name: COMPUTE_GBUFFER_NAME.to_string(),
            pipelines: vec![PathBuf::from(COMPUTE_GBUFFER_PIPELINE)],
        };
        ...
        Self {
            ...
            data_buffer_1,
            data_buffer_2,
            binding_data: BindingData::new(render_context, COMPUTE_GBUFFER_NAME),
