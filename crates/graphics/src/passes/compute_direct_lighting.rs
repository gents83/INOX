...
pub const COMPUTE_DIRECT_LIGHTING_PIPELINE: &str =
    "pipelines/ComputeDirectLighting.compute_pipeline";
pub const COMPUTE_DIRECT_LIGHTING_NAME: &str = "ComputeDirectLightingPass";

pub struct ComputeDirectLightingPass {
...
unsafe impl Send for ComputeDirectLightingPass {}
unsafe impl Sync for ComputeDirectLightingPass {}

impl Pass for ComputeDirectLightingPass {
    fn name(&self) -> &str {
        COMPUTE_DIRECT_LIGHTING_NAME
    }
        ...
        Self: Sized,
    {
        let data = ComputePassData {
            name: COMPUTE_DIRECT_LIGHTING_NAME.to_string(),
            pipelines: vec![PathBuf::from(COMPUTE_DIRECT_LIGHTING_PIPELINE)],
        };
        ...
        Self {
            ...
            lights,
            rays,
            binding_data: BindingData::new(render_context, COMPUTE_DIRECT_LIGHTING_NAME),
    ...
    fn init(&mut self, render_context: &RenderContext) {
        ...
        // Group 1: Geometry - add all buffers
        self.binding_data
            .add_buffer(
        ...
        // Group 3: texture_utils.inc (sampler + texture arrays)
        self.binding_data
            .add_default_sampler(
                BindingInfo {
                    group_index: 3,
...
impl ComputeDirectLightingPass {
