...
pub const CONSTANT_DATA_FLAGS_DISPLAY_BASE_COLOR: u32 = 1 << 11;
pub const CONSTANT_DATA_FLAGS_DISPLAY_METALLIC: u32 = 1 << 12;
pub const CONSTANT_DATA_FLAGS_DISPLAY_ROUGHNESS: u32 = 1 << 13;
pub const CONSTANT_DATA_FLAGS_USE_IBL: u32 = 1 << 14;
