...
use inox_render::{
    ...
    CONSTANT_DATA_FLAGS_DISPLAY_ROUGHNESS, CONSTANT_DATA_FLAGS_DISPLAY_SHADOW,
    ...
    pub fn new(context: &ContextRc, params: InfoParams) -> Self {
        ...
        let data = Data {
            ...
            visualization_debug_choices: vec![
                ...
                (
                    CONSTANT_DATA_FLAGS_DISPLAY_INDIRECT_DIFFUSE,
                    "Indirect Diffuse",
                ),
                (
                    CONSTANT_DATA_FLAGS_DISPLAY_INDIRECT_SPECULAR,
                    "Indirect Specular",
                ),
