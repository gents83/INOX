...
pub use macros::*;
pub use registry::*;
pub use sabi_serialize_attribute::*;
pub use serde;
...
// Object-safe trait bound inserted by sabi_serialize serialization. We want this just
...
// Object-safe trait bound inserted by sabi_serialize deserialization. We want this
